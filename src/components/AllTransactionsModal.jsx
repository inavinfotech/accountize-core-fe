...
import { 
  ...
  Trash2, Edit2, Calendar, Wallet, Receipt, RefreshCw 
} from 'lucide-react'

export default function AllTransactionsModal({ onClose }) {
  const { currentMonth, triggerRefresh } = useApp()
  ...
  return (
    <Modal title="All Transactions" onClose={onClose} size="large">
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
          ...
          {loading ? (
            ...
            <div className="table-wrapper" style={{ maxHeight: '42vh', overflowY: 'auto', border: 'none', borderRadius: 0 }}>
