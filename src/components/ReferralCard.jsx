...
import { Gift, Copy, Check, Users, Award, ExternalLink, ChevronDown, ChevronUp } from 'lucide-react'
import { useAuth } from '../context/AuthContext'
import { getUserReferralCode, getReferralStats } from '../lib/db'
import { analytics } from '../lib/analytics'

export default function ReferralCard({ defaultCollapsed = true }) {
  const { user } = useAuth()
    ...
    <div style={{
      ...
      <div
        ...
        style={{
          ...
          marginBottom: expanded ? 16 : 0, cursor: 'pointer', userSelect: 'none'
        }}
      >
      ...
      {expanded && (
        <div style={{ animation: 'fadeIn 0.2s ease-in-out' }}>
          ...
          <p style={{ fontSize: '0.62rem', color: '#94a3b8', marginTop: 12, lineHeight: 1.5, textAlign: 'center', marginBottom: 0 }}>
